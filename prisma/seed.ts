...
async function seedDatabase() {
  try {
    // Arrays com URLs de imagens, nomes criativos para barbearias, endereços fictícios e serviços
    const images = [
    ...
    // Criar barbearias com nomes e endereços fictícios
    const barbershops = [];
    for (let i = 0; i < 10; i++) {
      ...
      // Criar uma nova barbearia no banco de dados
      ...
      // Popular a barbearia com os serviços oferecidos
